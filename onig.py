...
if os.name in ("nt", "ce"):
    ...
    try:
        ...
        try:
            ...
            _libname = "libonig-%d.dll" % _onig_api_version
            libonig = ctypes.cdll.LoadLibrary(_libname)
elif sys.platform == "cygwin":
    # Cygwin
    _libname = "cygonig-%d.dll" % _onig_api_version
    libonig = ctypes.cdll.LoadLibrary(_libname)
elif sys.platform == "msys":
    # MSYS/MSYS2
    _libname = "msys-onig-%d.dll" % _onig_api_version
    libonig = ctypes.cdll.LoadLibrary(_libname)
else:
    # Unix
    _libname = "libonig.so"
...
ONIG_OPTION_NOTBOS              = (ONIG_OPTION_NEWLINE_CRLF << 1)
